...
public class Vector implements Cloneable, Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3226362716528795441L;
    ...
    /**
     * Gets the magnitude of the vector, defined as sqrt(x^2+y^2). The value
    ...
    public Vector crossProduct(Vector o) {
    	//TODO verify
        double newX = x * o.y + o.x * y;
        double newY = x * o.x - o.y * y;
    ...
    /**
     * Returns whether this vector is within a circle.
     *
     * @param origin circle origin.
     * @param radius circle radius
     * @return whether this vector is in the circle
     */
